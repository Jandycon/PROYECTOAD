		...
		ActionListener esteMetodo = new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				for (int i = 0; i < listaDev.size(); i++) {
					...
					String fech=listaDev.get(i).getFechastrdev();
	...
	private ActionListener devolverLibro() {
		ActionListener esteMetodo = new ActionListener() {
			public void actionPerformed(ActionEvent e) {				
				...
				String fechapres = (String) jtablapre.getValueAt(rowIdx, 2);
				String fechadevol = (String) jtablapre.getValueAt(rowIdx, 3);
				...
				Devolucion d = new Devolucion(isbn, dni, fechadev, devestado);
