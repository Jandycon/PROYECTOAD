...
public class CustomPanelPrestamo extends JPanel{
	...
	public CustomPanelPrestamo(String usuario,String pass) {
		...
		ActionListener esteMetodo = new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(isbnExists(isbn)) {
					...
					atacanteImp.agregarPrestamo(estePres);			
	...
	public void setTablesPreFromBD() {
		...
		ArrayList<Alumno> listaAlumnos = atacanteImp.getAllAlumnos();
		...
		ArrayList<Libro> listaLibros = atacanteImp.getAllLibros();
